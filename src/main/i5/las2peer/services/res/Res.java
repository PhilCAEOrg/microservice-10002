...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "10002", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-10002/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getSongs() {
    ...
    if(res_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity("test").build();
    }
    return null;
  }
